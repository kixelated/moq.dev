...
<a href="/watch?project=demo&name=bbb.hang" class="!text-white no-underline">
	<article class="p-4 rounded-lg grid grid-cols-3 gap-4 items-center hover:bg-blue-950 hover:scale-105 hover:translate-x-2 transition-all ease-in-out">
		<div class="flex justify-center">
...
<a href="/publish" class="!text-white no-underline">
	<article class="p-4 rounded-lg grid grid-cols-3 gap-4 items-center hover:bg-blue-950 hover:scale-105 hover:translate-x-2 transition-all ease-in-out">
		...
		<div class="col-span-2 grid gap-2">
			...
			<div class="text-sm font-light">
				Go live! Share your camera, microphone, or screen with anyone you give the watch link to. Browser demos use a private broadcast in the try project.
			</div>
		</div>
	</article>
</a>
